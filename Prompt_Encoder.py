...
if __name__ == '__main__':
    ...
    net = PromptEncoder(embed_dim=96, image_embedding_size=(80, 80), input_image_size=(320, 320), mask_in_chans=16, activation=nn.GELU).to(device)

    points_coords = torch.randint(low=0, high=10, size=(2, 10, 2))
